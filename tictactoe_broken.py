...
def add_piece(game, player, row, column):
    ...
    """
    game[row][column] = player #Removed the +1 in the column in order to make sure the index isn't larger than the length of the list.
    return game
...
if __name__ == '__main__':
    ...
    while winner == 0 and moves_exist(game):
        ...
        winner = check_winner(game) #Removed the comment symbol.
